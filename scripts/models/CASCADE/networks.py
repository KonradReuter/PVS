...
from scripts.models.CASCADE.pvtv2 import pvt_v2_b2
from scripts.models.CASCADE.decoders import CASCADE
from scripts.models.CASCADE.cnn_vit_backbone import Transformer, SegmentationHead
...
class PVT_CASCADE(nn.Module):
    def __init__(self, n_class=1):
        ...
        path = 'scripts/models/CASCADE/pvt_v2_b2.pth'
...
def get_CASCADE():
    return SingleImageModelWrapper(PVT_CASCADE())

if __name__ == '__main__':
    from scripts.utils import SingleImageModelWrapper, count_parameters
    model = SingleImageModelWrapper(PVT_CASCADE())
    input_tensor = torch.randn(2, 5, 3, 256, 256)
