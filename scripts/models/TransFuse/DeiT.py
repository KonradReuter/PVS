...
from scripts.models.TransFuse.vision_transformer import VisionTransformer, _cfg
...
def deit_small_patch16_224(pretrained=False, **kwargs):
    ...
    if pretrained:
        ckpt = torch.load('scripts/models/TransFuse/deit_small_patch16_224-cd65a155.pth')
...
def deit_base_patch16_224(pretrained=False, **kwargs):
    ...
    model.default_cfg = _cfg()
    if pretrained:
        ckpt = torch.load('deit_base_patch16_224-b5f2ef4d.pth')
        model.load_state_dict(ckpt['model'], strict=False)
...
def deit_base_patch16_384(pretrained=False, **kwargs):
    ...
    model.default_cfg = _cfg()
    if pretrained:
        ckpt = torch.load('deit_base_patch16_384-8de9b5d1.pth')
