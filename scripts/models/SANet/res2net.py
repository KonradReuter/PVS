...
class Res2Net(nn.Module):
    def __init__(self, layers, baseWidth=26, scale=4):
        self.inplanes = 64
    ...
    def initialize(self):
        ...
        self.load_state_dict(model_zoo.load_url('https://shanghuagao.oss-cn-beijing.aliyuncs.com/res2net/res2net50_v1b_26w_4s-3cf99910.pth', map_location=device), strict=False)
        print("Done!")

def Res2Net50():
    return Res2Net([3, 4, 6, 3])
