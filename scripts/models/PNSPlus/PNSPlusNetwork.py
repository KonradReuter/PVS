...
from scripts.models.PNSPlus.Res2Net_v1b import res2net50_v1b_26w_4s
...
class PNSPlusNet(nn.Module):
    def __init__(self):
        super(PNSPlusNet, self).__init__()
        ...
        self.NSB_global = NS_Block(32, radius=[3, 3, 3, 3], dilation=[3, 4, 3, 4], h=16, w=16)
        self.NSB_local = NS_Block(32, radius=[3, 3, 3, 3], dilation=[1, 2, 1, 2], h=16, w=16)
    ...
    def forward(self, x):
        ...
        # bring back into temporal form
        out = out.view(origin_shape[0], (origin_shape[1]-1), *out.shape[1:])
