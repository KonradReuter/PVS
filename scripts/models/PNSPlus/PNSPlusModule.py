...
class NS_Block(nn.Module):
    def __init__(self, channels_in=32, h=40, w=40, n_head=4, d_k=8, d_v=8, radius=[3, 3, 3, 3], dilation=[1, 3, 5, 7]):
    ...
    def forward(self, first, x):
        ...
        # shape: b x f x c/n_heads x h x w
...
if __name__ == "__main__":
    import time
    sample_input = torch.randn(1, 5, 256, 32, 32).to("cuda")
    model = NS_Block(256, 32, 32).to("cuda")
