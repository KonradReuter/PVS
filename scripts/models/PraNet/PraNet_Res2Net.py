...
from scripts.models.PraNet.Res2Net_v1b import res2net50_v1b_26w_4s
...
def get_PraNet():
    return SingleImageModelWrapper(PraNet().to(device))

if __name__ == '__main__':
    from scripts.utils import SingleImageModelWrapper, count_parameters
    ras = SingleImageModelWrapper(PraNet().to(device))
    input_tensor = torch.randn(1, 5, 3, 256, 256).to(device)

    out = ras(input_tensor)
    print(type(out))
    for o in out:
        print(o.shape)
    print(count_parameters(ras))